...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in FedOpt_pb2_grpc.py depends on'
...
class CommunicationStub(object):
    ...
    def __init__(self, channel):
        ...
        self.SendToClient = channel.unary_unary(
...
class CommunicationServicer(object):
    ...
    def SendToClient(self, request, context):
        """Missing associated documentation comment in .proto file."""
        context.set_code(grpc.StatusCode.UNIMPLEMENTED)
        context.set_details('Method not implemented!')
        raise NotImplementedError('Method not implemented!')
...
def add_CommunicationServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SendToClient': grpc.unary_unary_rpc_method_handler(
